<template>
    <div class="min-h-screen w-full bg-gray-50">
        <section id="film">
          <div class="relative max-h-screen    h-[85vh]">
            ...
            <!-- <div class="absolute inset-0 flex justify-center items-center z-12  object-cover ">
                <span class="text-8xl font-semibold text-center text-gray-100 ">O nas</span>
            </div> -->
       ...
       <!-- Sekcja 1 -->
       <section class="w-full bg-white flex justify-center py-10 md:py-16">
        <div class="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8 px-4 sm:px-6 lg:px-8">
            
            <!-- Tekst -->
            <div class="w-full max-w-xl mx-auto md:mx-0 text-left space-y-4">
            ...
            <img src="@/assets/img/firma.jpg" alt="Opis obrazka" class="object-cover w-full h-auto max-w-xl">
            </div>
       ...
       <!-- Sekcja 2 (z tłem) -->
       <section class="w-full bg-gray-100 flex justify-center py-10 md:py-16">
        <div class="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8 px-4 sm:px-6 lg:px-8">
            
          

            <div class="grid grid-cols-2 grid-rows-2 gap-4">
                <img src="@/assets/img/rfiddwa.png" alt="Opis obrazka" class="object-cover w-full h-auto max-w-xl">
                <img src="@/assets/img/rfid.jpg" alt="Opis obrazka" class="object-cover w-full h-auto max-w-xl">
                <img src="@/assets/img/pul.jpg" alt="Opis obrazka" class="object-cover w-full h-auto max-w-xl">
                <img src="@/assets/img/antenaa.jpg" alt="Opis obrazka" class="object-cover w-full h-auto max-w-xl">

            </div>

            <div class="w-full max-w-xl pl-5 mx-auto md:mx-0 text-left space-y-4">
       ...
       <section class="w-full bg-white flex justify-center py-10 md:py-16">
        <div class="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8 px-4 sm:px-6 lg:px-8">
            ...
            <!-- Tekst -->
            <div class="w-full max-w-xl mx-auto md:mx-0 text-left space-y-4">
            <h1 class="text-3xl md:text-4xl font-semibold text-gray-800">Indywidualne podejście           
            </h1>
            ...
            <p class="text-gray-700 text-md  leading-relaxed">
              ...
              Nasze wdrożenia to kompleksowy proces realizowany w przejrzystych etapach:
              </p>
              <ul class="font-base text-base xl:text-medium font-medium text-pretty text-gray-700 space-y-5 lg:mt-4 mb-1 tracking-wide list-none">
                <li class="flex items-center gap-3">
                  <div class="flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#1D4ED8" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
                      <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"/>
                    </svg>
                  </div>
                  <span class="flex-1">Szczegółowa analiza procesów przedsiębiorstwa klienta</span>
                </li>
                <li class="flex items-center gap-3">
                  <div class="flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#1D4ED8" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
                  ...
                  <span class="flex-1">Konfiguracja systemu, tworzenie nowych funkcjonalności i migracja danych</span>
                </li>
                <li class="flex items-center gap-3">
                  <div class="flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#1D4ED8" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
                  ...
                  <span class="flex-1">Szkolenia użytkowników oraz opieka powdrożeniowa</span>
                </li>
              </ul>
            ...
            <!-- Obrazek -->
            <div class="flex justify-center">
            <img src="@/assets/img/Pulsarfirst.jpg" alt="Opis obrazka" class="object-cover w-full h-auto max-w-xl">
            </div>
       ...
       <section class="w-full bg-gray-100 flex justify-center py-10 md:py-16">
        <div class="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8 px-4 sm:px-6 lg:px-8">
            ...
            <img src="@/assets/img/SiemensOracle.png" alt="Opis obrazka" class="object-cover w-full h-auto max-w-xl">
            </div>

            <div class="w-full max-w-xl mx-auto md:mx-0 text-left space-y-4 ">
            <h1 class=" text-3xl md:text-4xl font-semibold max-md:text-center text-gray-800">Partnerstwo z najlepszymi</h1>
  ...
  <script setup>
    import LogosGrid from '@/components/LogosGrid.vue'
    import { ref } from 'vue'
